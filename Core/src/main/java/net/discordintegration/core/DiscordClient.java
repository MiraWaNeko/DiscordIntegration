...
public class DiscordClient extends ListenerAdapter {
    ...
    public void updateChannelDescription(long id, String message) {
        ...
        if (textChannelById != null) {
            List<Permission> permissions = textChannelById.getGuild().getMember(this.getSelf()).getPermissions(textChannelById);
            if (!permissions.contains(Permission.MANAGE_CHANNEL)) {
                ...
                DiscordIntegrationLogger.Log(
                    String.format(
                        "Missing permission to change channel description for channel %s (%s)",
            ...
            try {
                ...
                DiscordIntegrationLogger.Log(
                    String.format(
                        "Error occurred while changing channel description for channel %s (%s)",
                        textChannelById.getName(),
                        id
                    )
                );

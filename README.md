...
[![Build Status](https://build.chikachi.net/buildStatus/icon?job=Chikachi/DiscordIntegration/1.9.4)](https://build.chikachi.net/job/Chikachi/job/DiscordIntegration/job/1.9.4/)
